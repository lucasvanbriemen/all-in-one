module Music
  class KaraokeScore < ApplicationRecord
    ...
    # MariaDB backs json columns with longtext plus a json_valid check, which
    # the adapter reports as text — declaring the type keeps hashes
    # round-tripping (the talk_segments.meta precedent).
    attribute :meta, :json
